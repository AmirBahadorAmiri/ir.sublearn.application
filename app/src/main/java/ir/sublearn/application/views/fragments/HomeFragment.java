...
import ir.sublearn.application.adapters.SeriesAdapter;
...
import ir.sublearn.application.views.activities.MoviesExplorerActivity;
import ir.sublearn.application.views.activities.ProfileActivity;
import ir.sublearn.application.views.activities.SeriesExplorerActivity;
...
public class HomeFragment extends Fragment {
    ...
    AppCompatImageView fragment_home_settings_icon, fragment_home_profile_icon;
    AppCompatTextView fragment_home_cinema_more, fragment_home_series_more;
    RecyclerView fragment_home_series_recyclerView, fragment_home_cinema_recyclerView;
    ...
    private void findViews(View view) {
        fragment_home_settings_icon = view.findViewById(R.id.fragment_home_settings_icon);
        fragment_home_profile_icon = view.findViewById(R.id.fragment_home_profile_icon);
        fragment_home_series_recyclerView = view.findViewById(R.id.fragment_home_series_recyclerView);
        fragment_home_cinema_recyclerView = view.findViewById(R.id.fragment_home_cinema_recyclerView);
        fragment_home_cinema_more = view.findViewById(R.id.fragment_home_cinema_more);
        fragment_home_series_more = view.findViewById(R.id.fragment_home_series_more);
    }

    private void setup(View view) {

        fragment_home_settings_icon.setOnClickListener(v -> {
            startActivity(new Intent(requireContext(), SettingsActivity.class));
        });

        fragment_home_profile_icon.setOnClickListener(v -> {
            startActivity(new Intent(requireContext(), ProfileActivity.class));
        });

        fragment_home_series_more.setOnClickListener(v -> startActivity(new Intent(requireContext(), SeriesExplorerActivity.class)));
        fragment_home_cinema_more.setOnClickListener(v -> startActivity(new Intent(requireContext(), MoviesExplorerActivity.class)));

        moviesAdapter = new MoviesAdapter(moviesModels);
        fragment_home_cinema_recyclerView.setLayoutManager(new LinearLayoutManager(requireContext(), RecyclerView.HORIZONTAL, false));
        fragment_home_cinema_recyclerView.setAdapter(moviesAdapter);

        seriesAdapter = new SeriesAdapter(seriesModelList);
        fragment_home_series_recyclerView.setLayoutManager(new LinearLayoutManager(requireContext(), RecyclerView.HORIZONTAL, false));
        fragment_home_series_recyclerView.setAdapter(seriesAdapter);
